        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-md-12">
                    ...
                    <!-- Save the Code -->
                    <button id="update-code" class="btn btn-success mt-3">Update Code</button>
    ...
    <script>
        ...
        require(['vs/editor/editor.main'], function() {
            ...
            editor = monaco.editor.create(document.getElementById('monaco-editor'), {
                value: {!! json_encode($codeEditor->code) !!},
                language: 'javascript',
                theme: 'vs-dark',
            });
            ...
            document.getElementById('update-code').addEventListener('click', function() {
                if (editor) {  // Check if editor is initialized
                    var code = editor.getValue();  // Get the code from Monaco Editor
                    var codeEditorId = {{ $codeEditor->codeID }}; // Ensure this is correctly fetching the ID

                    // AJAX request to send the code to Laravel server
                    fetch(`/codeEditor/${codeEditorId}`, {
                        method: 'PUT',
                        headers: {
