    ...
    <div class="modal-dialog sidebar-lg">
      <div class="modal-content p-0">
        ...
        <div class="modal-body flex-grow-1 pb-sm-0 pb-3">
          <form action="{{route('event.store')}}" data-ajax="false" novalidate>
            <div class="mb-1">
              <label for="title" class="form-label {{ $errors->has('title') ? 'has-error' : '' }}">Title</label>
              <input type="text" class="form-control @if($errors->has('title')) is-invalid @endif" id="title" name="title" placeholder="Event Title" />
              @if($errors->has('title'))
            ...
            <div class="mb-1">
              <label for="select-label" class="form-label {{ $errors->has('label') ? 'has-error' : '' }}">Label</label>
              <select class="select2 select-label form-select w-100 @if($errors->has('label')) is-invalid @endif" id="select-label" name="label">
            ...
            <div class="mb-1 position-relative">
              <label for="start-date" class="form-label {{ $errors->has('startDate') ? 'has-error' : '' }}">Start Date</label>
              <input type="text" class="form-control @if($errors->has('startDate')) is-invalid @endif" id="start-date" name="startDate" placeholder="Start Date" />
            ...
            <div class="mb-1 position-relative">
              <label for="end-date" class="form-label {{ $errors->has('endDate') ? 'has-error' : '' }}">End Date</label>
              <input type="text" class="form-control @if($errors->has('endDate')) is-invalid @endif" id="end-date" name="endDate" placeholder="End Date" />
            ...
            <div class="mb-1">
              ...
              <textarea id="event-description-editor" class="form-control" name="description"></textarea>
            </div>
