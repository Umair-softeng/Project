...
@section('content')
    <div class="card" xmlns="http://www.w3.org/1999/html">
        ...
        <div class="card-body">
            <form action="{{route('student.store')}}" class="row gy-1 pt-75 needs-validation" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4 ">
                        ...
                        <input type="text"  name="name" id="name" class="form-control @if($errors->has('name')) is-invalid @endif" placeholder="Enter Quantity" value="{{ old('name') }}"/>
                        @if($errors->has('name'))
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4 ">
                        ...
                        <input type="text"  name="fatherName" id="fatherName" class="form-control @if($errors->has('fatherName')) is-invalid @endif" placeholder="Enter Father Name" value="{{ old('fatherName') }}"/>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4 ">
                        ...
                        <input type="email"  name="email" id="email" class="form-control @if($errors->has('email')) is-invalid @endif" placeholder="Enter Email" value="{{ old('email') }}"/>
                        @if($errors->has('email'))
                            <em class="invalid-feedback">
                                {{ $errors->first('email') }}
                            </em>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4 ">
                        ...
                        <input type="text"  name="cnic" id="cnic" class="cnic form-control @if($errors->has('cnic')) is-invalid @endif" placeholder="Enter Cnic" value="{{ old('cnic') }}"/>
                        @if($errors->has('cnic'))
                            <em class="invalid-feedback">
                                {{ $errors->first('cnic') }}
                            </em>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4 ">
                        ...
                        <input type="text"  name="mobileNo" id="mobileNo" class="mobileNo form-control @if($errors->has('mobileNo')) is-invalid @endif" placeholder="Enter Mobile No" value="{{ old('mobileNo') }}"/>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4 ">
                        ...
                        <select class="form-select select2 @if($errors->has('qualification')) is-invalid @endif" name="qualification" id="qualification">
                            <option value="Matric" {{old('qualification') == "Matric" ? "selected" : ""}}>Matric</option>
                            <option value="FSC/FA" {{old('qualification') == "FSC/FA" ? "selected" : ""}}>FSC/FA</option>
                            <option value="Bachelors" {{old('qualification') == "Bachelors" ? "selected" : ""}}>Bachelors</option>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4 ">
                        ...
                        <input type="degree"  name="degree" id="degree" class="form-control @if($errors->has('degree')) is-invalid @endif" placeholder="Enter Degree" value="{{ old('degree') }}"/>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4 ">
                        ...
                        <input type="passingYear"  name="passingYear" id="passingYear" class="form-control @if($errors->has('passingYear')) is-invalid @endif" placeholder="Enter Passing Year" value="{{ old('passingYear') }}"/>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4 ">
                        ...
                        <input type="experience"  name="experience" id="experience" class="form-control @if($errors->has('experience')) is-invalid @endif" placeholder="Enter Experience" value="{{ old('experience') }}"/>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-4 ">
                        ...
                        <textarea type="address"  name="address" id="address" class="form-control @if($errors->has('address')) is-invalid @endif" placeholder="Enter Address" />{{ old('address') }}</textarea>
