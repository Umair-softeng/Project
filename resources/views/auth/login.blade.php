...
@section('content')
    <div class="auth-wrapper auth-cover">
        <div class="auth-inner row m-0">
            <!-- Brand logo-->
            <a class="brand-logo" href="{{route('textEditor.index')}}">
            ...
            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                    <h2 class="card-title fw-bold mb-1">Welcome to Technical Online Interview Platform! 👋</h2>
                    ...
                    <form class="auth-login-form mt-2" action="{{route('login')}}" method="POST" autocomplete="off">
                        ...
                        <button class="btn w-100" tabindex="4" style="background: #7367f0; color: white">Sign in</button>
                    </form>
                    <p class="mt-2">
