            ...
            <ul class="nav navbar-nav">
                <li class="nav-item">
                    ...
                    <span class="brand-logo">
                        ...
                        <h2 class="brand-text mb-0">MCQ LRMS</h2>
                    </a>
                </li>
            </ul>
        </div>
        @else
            <nav class="header-navbar navbar navbar-expand-lg align-items-center {{ $configData['navbarClass'] }} navbar-light navbar-shadow {{ $configData['navbarColor'] }} {{ $configData['layoutWidth'] === 'boxed' && $configData['verticalMenuNavbarType'] === 'navbar-floating' ? 'container-xxxl' : '' }}">
                @endif
                <div class="navbar-container d-flex content">
                    <div class="bookmark-wrapper d-flex align-items-center">
                        <ul class="nav navbar-nav d-xl-none">
                                ...
                                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user"
                                   ...
                                   aria-expanded="false">
                                    <div class="user-nav d-sm-flex d-none">
                                        ...
                                        <span class="user-status">{{\Illuminate\Support\Facades\Auth::user()->roles[0]->roleName}}</span>
                                    </div>
                                    <span class="avatar">
                                      <img class="round"
                                           src="{{ Auth::user() ? asset('images/portrait/small/avatar-s-11.jpg') : asset('images/portrait/small/avatar-s-11.jpg') }}"
                                           alt="avatar" height="35" width="40">
                                      <span class="avatar-status-online"></span>
                                    </span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                                    <a class="dropdown-item" href="{{route('user.show', auth()->user()->userID)}}">
